<x-app-layout>
    <section class="mx-auto min-h-full w-full max-w-screen-xl space-y-4 px-2 pb-16 pt-4 text-black md:px-16">
        <div class="flex justify-between rounded-lg bg-primary p-4 text-white">
            <div>
                <h1 class="md:text-2xl">Selamat Datang</h1>
                <h2 class="md:text-2xl">{{ auth()->user()->name }} !</h2>
            ...
            <div class="flex flex-col text-right font-semibold">
                <h1 class="text-sm">Sistem Informasi Akademik</h1>
                <h1>SMA Negeri 1 Jati Agung</h1>
                <h1 class="mt-4 md:mt-8">Tahun Akademik {{ $currentTahunAkademik?->name ?? '' }}</h1>
            </div>
        </div>
        ...
        <div class="w-full rounded-md bg-zinc-100 p-4">
            ...
            <canvas id="kelulusanChart" class="w-full"></canvas>
        </div>
    </section>
