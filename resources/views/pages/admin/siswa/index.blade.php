<x-app-layout>
    <section class="mx-auto min-h-full w-full max-w-screen-xl space-y-4 px-2 pt-4 text-black md:px-16">
        <div class="rounded border border-zinc-300 p-2">
            <h1 class="mb-2 font-semibold">JUMLAH SISWA</h1>
            <div class="grid grid-cols-2 rounded border border-zinc-300 p-2 text-center">
                <div class="divide-y">
                    ...
                    <h3 class="py-4 text-2xl font-semibold">{{ $jumlahSiswa->lakiLaki }}</h3>
                </div>

                <div class="divide-y">
                    <h2 class="py-2 font-semibold text-green-500">PEREMPUAN</h2>
                    <h3 class="py-4 text-2xl font-semibold">{{ $jumlahSiswa->perempuan }}</h3>
                </div>
            </div>
        </div>

        <div class="space-y-2 rounded border border-zinc-300 p-2">
            <h1 class="font-semibold">SEMUA SISWA</h1>

            <!--table-->
            <livewire:table.admin.table-siswa />
        </div>
    </section>
</x-app-layout>
